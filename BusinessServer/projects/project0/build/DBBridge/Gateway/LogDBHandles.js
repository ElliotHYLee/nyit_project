...
exports.deleteByIP = exports.deleteAll = exports.logConn = exports.findAll = exports.connect2mdb = void 0;
var Schemas_1 = require("./Schemas");
var mongoose = require("mongoose");
function connect2mdb() {
    mongoose
        .connect("mongodb://admin:admin@connlog_mongo:27017", {
        useNewUrlParser: true,
        serverSelectionTimeoutMS: 3000,
    })
        .then(function () { return console.log("LogDB Connected"); })
        .catch(function (err) { return console.log(err); });
}
exports.connect2mdb = connect2mdb;
function findAll() {
